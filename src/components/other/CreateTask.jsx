...
const CreateTask = () => {
    return (
        <div className='bg-[#1c1c1c] p-5 mt-5 rounded'>
            <form className='flex justify-between w-full flex-wrap items-start'>
                <div className='w-1/2'>
                    <div>
                ...
                <div className='w-2/5 flex flex-col items-start'>
                    ...
                    <textarea className='text-sm w-full h-44 py-2 px-4 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400' name="" id=""></textarea>
